...
hat is evenly divisible by 4, unless the year is also divisible by 100. If the 
ear is evenly divisible by 100, then it is not a leap year unless the year is 
...
Assume this rule is good for any year greater than year 0. Write a method that
 ...
 ar, or false if it is not a leap year.
 
=end


def leap_year?(year)
  p (year % 400 == 0) || (year % 4 == 0 && year % 100 != 0)
end
